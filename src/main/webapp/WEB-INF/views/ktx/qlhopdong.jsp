		...
		<div class="page-content">
			...
			<div class="card">
				...
				<div class="card-body">
					...
					<!-- /////////////////////////////////////////// -->
					<form:form action="ktx/qlhopdong/action/${id_NV}.htm"
						modelAttribute="hopDong">
							...
							<fmt:formatDate value="${date}" pattern="yyyy-MM-dd" var="datenow" />
							 <div class="form-group row">
								...
								<div class="col-lg-9 col-xl-8">
									<form:input path="ngayLap" value="${datenow}"  class="form-control" type="date" readonly="true"/>
							...
							<div class="form-group row">
								<div class="col-lg-9 col-xl-8 offset-lg-3">
									...
									<form:button formaction="ktx/qlhopdong/${id_NV}.htm" type="submit"
