					...
					<div class="col-lg-5 mx-auto">
						<div class="card">
							<div class="card-body p-0 auth-header-box">
								<div class="text-center p-3">
									...
									<h4 class="mt-3 mb-1 fw-semibold text-white font-18">Quản
										lý Kí túc xá</h4>
									<p class="text-muted  mb-0">Nhóm 28</p>
								</div>
							</div>
							<div class="card-body p-0">
								<ul class="nav-border nav nav-pills" role="tablist">
									<li class="nav-item"><a
										...
										href="login.htm" role="tab">Đăng nhập</a></li>
								</ul>
								<!-- Tab panes -->
										...
										<form:form class="form-horizontal auth-form"
											...
											<div class="form-group mb-2">
												...
												<div class="input-group">
													<form:input path="taiKhoan" type="text"
							...
							<div class="card-body bg-light-alt text-center">
								<span class="text-muted d-none d-sm-inline-block">Nhom28© <script>
										document
