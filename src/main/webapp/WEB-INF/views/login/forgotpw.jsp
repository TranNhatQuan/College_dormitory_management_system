					...
					<div class="col-lg-5 mx-auto">
						<div class="card">
							<div class="card-body p-0 auth-header-box">
								<div class="text-center p-3">
									<a href="login.htm" class="logo logo-admin"> <img
										src="resources/dashtone/assets/images/logo-ptithcm1.png"
										height="50" alt="logo" class="auth-logo">
										
									</a>
									<h4 class="mt-3 mb-1 fw-semibold text-white font-18">Quên mật khẩu</h4>
									<p class="text-muted  mb-0">Nhập địa chỉ email và nhận mã xác nhận!</p>
								</div>
							</div>
							<div class="card-body">
								...
								<c:if test="${show=='sendCode'}">
										...
										<div class="form-group mb-0 row">
											<div class="col-12 mt-2">
												<button
													...
													type="submit">Gửi mã xác nhận<i class="fas fa-sign-in-alt ms-1"></i>
												</button>
											</div>
											<!--end col-->
										</div>
									...
									<p class="text-muted mb-0 mt-3">
										Đã nhớ lại? <a href="login/index.htm"
											class="text-primary ms-2">Đăng nhập tại đây</a>
									</p>
								</c:if>
										...
										<div class="form-group mb-2">
											...
											<div class="input-group">
												<input name="confirmpw" type="password" class="form-control"
													id="email" placeholder="Nhập lại mật khẩu mới" pattern="{1,50}">
											</div>
										</div>
										<!--end form-group-->
										<div class="form-group mb-0 row">
							...
							<div class="card-body bg-light-alt text-center">
								<span class="text-muted d-none d-sm-inline-block">Nhom28©
									© <script>
										document
